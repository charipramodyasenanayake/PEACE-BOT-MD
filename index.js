...
async function startMiku() {
    ...
    console.log(color(figlet.textSync('Peace Bot MD', {
        font: 'Pagga',
    ...
    console.log(color('\nPeace, I am Charith Senanayake, The main developer of PeaceMD bot.\n\nThanks for using: Peace MD made by Charith Praomdya Senanayake.', 'aqua'))
    console.log(color('\nText Me: https://wa.me/94712448370\n\n', 'aqua'))
    ...
    Miku.ev.on('connection.update', async (update) => {
        ...
        status = connection;
        if (connection) {
            await console.info(`PEACE MD Server Status => ${connection}`);
          }
